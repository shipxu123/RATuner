...
with open('/home/pxu/codes/RATuner/results/tfidf-embeddings/command_embedding.json', 'r') as json_file:
...
def find_optimal_clusters(data, max_k):
    ...
    plt.savefig('/home/pxu/codes/RATuner/results/tfidf-embeddings/k-Means-plotting.pdf')
...
def plot_tsne_pca(data, labels):
    ...
    # plt.legend(loc="upper right")
    plt.savefig('/home/pxu/codes/RATuner/results/tfidf-embeddings/k-Means-clustering.pdf')
...
print(clusters)
with open('/home/pxu/codes/RATuner/results/tfidf-embeddings/cluster.json', 'w') as json_file:
